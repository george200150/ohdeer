...
public class VacuumState extends State {
	...
	/**
	 * Returns the single.agent's orientation. Note that the constants in the Direction
	...
	/** Returns a string the represents the single.agent's orientation. */
	...
	/** Changes the single.agent's orientation. */
